...
import { Box, Container, fontFamily } from "@mui/system";
    ...
    <Container>
      ...
      >
        <Box sx={{ width: "74%" }}>
          ...
          <StyledTypography>Reason for choosing</StyledTypography>
      ...
      >
        ...
        >
          <Box sx={{display:"flex",width:"50%",alignItems:"center",gap:2}}>
            <Box sx={{fontSize:"60px"}}><CountUp end={3} duration={4} />K</Box>
            <Box sx={{fontSize:"20px"}}>Projects Completed</Box>
          </Box>
          <Box sx={{display:"flex",width:"50%",alignItems:"center",gap:2}}>
            <Box sx={{fontSize:"60px"}}><CountUp end={2} duration={4} />K</Box>
            <Box sx={{fontSize:"20px"}}>Industrires Served</Box>
          </Box>
          <Box sx={{display:"flex",width:"50%",alignItems:"center",gap:2}}>
            <Box sx={{fontSize:"60px"}}><CountUp end={139} duration={2} /></Box>
            <Box sx={{fontSize:"20px"}}>Expert Team Mates</Box>
          </Box>
          <Box sx={{display:"flex",width:"50%",alignItems:"center",gap:2}}>
            <Box sx={{fontSize:"60px"}}><CountUp end={14} duration={4} />m</Box>
